...
public class AplikasiPerhitunganDiskon extends javax.swing.JFrame {
   ...
   public AplikasiPerhitunganDiskon() {
    ...
    jComboBox1.addActionListener(evt -> {
        String s = ((String) jComboBox1.getSelectedItem()).replace("%", "");
        try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      try {
        ...
        if (kode.equalsIgnoreCase("HEMAT10")) {
            diskon += 10;
        } else if (kode.equalsIgnoreCase("SUPER50")) {
            diskon += 50;
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Bisa tampilkan riwayat di dialog atau sudah di textArea
    ...
    // Kosongkan dulu text area, lalu tampilkan semua riwayat
    jTextArea1.setText("");
